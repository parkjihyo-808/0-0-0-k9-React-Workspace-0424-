...
const PdItemWalking = ({ article }) => {
  const { MAIN_TITLE, ADDR1, ITEMCNTNTS, MAIN_IMG_THUMB, HOMEPAGE_URL, TR_COURSE } = article;
  ...
  return (
    <NewsItemBlock>
      ...
      <div className="contents">
        ...
        <p>📍 <strong>코스:</strong> {TR_COURSE}</p>
        <p>상세설명: {ITEMCNTNTS}</p>
        <p>주소: {ADDR1}</p>
      </div>
    </NewsItemBlock>
